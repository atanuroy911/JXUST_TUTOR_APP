...
public class AvailableTimeSeeder {
    ...
    public static void insert(DBHelper db) {
        ...
        calendarStartTime.set(Calendar.YEAR, 2021);
        ...
        calendarEndTime.set(Calendar.YEAR, 2021);
        ...
        db.availableTime.insert(startTime,endTime,2);
        ...
        db.availableTime.insert(startTime,endTime,3);
        ...
        db.availableTime.insert(startTime,endTime,4);
        ...
        db.availableTime.insert(startTime,endTime,5);
    }
}
